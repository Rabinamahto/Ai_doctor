...
export default function DoctorDetails() {
  ...
  const reviews = [
    ...
    { id: 2, name: 'Priya Singh', rating: 5, text: 'Great experience, highly recommend!', date: '1 month ago' },
    { id: 3, name: 'Rahul Verma', rating: 4, text: 'Good consultation, helped me a lot.', date: '3 weeks ago' }
  ];
